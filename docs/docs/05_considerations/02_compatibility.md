...
|        `nestjs-cls`        | `<= 4.x` | `>= 5.0 <= 5.1` | `>= 5.2 <= 6.2` | `>= 6.3 <= 6.x` |   `>= 7.0`    |
| :------------------------: | :------: | :-------------: | :-------------: | :-------------: | :-----------: |
|         `Node.js`          | `>= 16`  |     `>= 16`     |     `>= 18`     |     `>= 18`     |    `>= 22`    |
|   `@nestjs/core,common`    | `<= 10`  |     `>= 11`     |  `>= 10 <= 11`  |  `>= 10 <= 12`  | `>= 10 <= 12` |
| `@nestjs/platform-express` | `<= 10`  |     `>= 11`     |  `>= 10 <= 11`  |  `>= 10 <= 12`  | `>= 10 <= 12` |
| `@nestjs/platform-fastify` | `<= 10`  |     `>= 11`     |  `>= 10 <= 11`  |  `>= 10 <= 12`  | `>= 10 <= 12` |
|     `@nestjs/graphql`      | `<= 12`  |     `>= 13`     |  `>= 12 <= 13`  |  `>= 12 <= 14`  | `>= 12 <= 14` |
|         `graphql`          | `<= 16`  |     `>= 16`     |     `>= 16`     |     `>= 16`     |    `>= 16`    |
|      `@nestjs/apollo`      | `<= 12`  |     `>= 13`     |  `>= 12 <= 13`  |  `>= 12 <= 14`  | `>= 12 <= 14` |
|      `@apollo/server`      |  `<= 4`  |     `>= 4`      |     `>= 4`      |     `>= 4`      |    `>= 4`     |
|    `@nestjs/mercurius`     | `<= 12`  |     `>= 13`     |  `>= 12 <= 13`  |  `>= 12 <= 14`  | `>= 12 <= 14` |
|        `mercurius`         | `<= 13`  |     `>= 16`     |     `>= 10`     |     `>= 10`     |    `>= 10`    |
|    `@nestjs/websockets`    | `<= 10`  |     `>= 11`     |  `>= 10 <= 11`  |  `>= 10 <= 12`  | `>= 10 <= 12` |
|   `@nestjs/platform-ws`    | `<= 10`  |     `>= 11`     |  `>= 10 <= 11`  |  `>= 10 <= 12`  | `>= 10 <= 12` |
